# 1 "c:\\users\\user\\documents\\vugen\\scripts\\uc5_deletebooking\\\\combined_UC5_DeleteBooking.c"
...
# 1 "c:\\users\\user\\documents\\vugen\\scripts\\uc5_deletebooking\\\\combined_UC5_DeleteBooking.c" 2
...
# 2 "c:\\users\\user\\documents\\vugen\\scripts\\uc5_deletebooking\\\\combined_UC5_DeleteBooking.c" 2
...
# 3 "c:\\users\\user\\documents\\vugen\\scripts\\uc5_deletebooking\\\\combined_UC5_DeleteBooking.c" 2
...
# 4 "c:\\users\\user\\documents\\vugen\\scripts\\uc5_deletebooking\\\\combined_UC5_DeleteBooking.c" 2
...
Action()
{
	...
	if (countOfFLights!=0) {
		...
		if (tfDeleteAll==0) {
			...
			lr_end_transaction("DeleteAllFlight",2);	
	...
	lr_end_transaction("UC5_DeleteBooking",2);
...
int deleteRandomTickets(int countOfFLights){
	...
	int hh1=0;
	int j = 0;
	int colDeleteFlights = 1 + rand()%(countOfFLights);
	int hhh[10];
...
# 5 "c:\\users\\user\\documents\\vugen\\scripts\\uc5_deletebooking\\\\combined_UC5_DeleteBooking.c" 2
...
# 6 "c:\\users\\user\\documents\\vugen\\scripts\\uc5_deletebooking\\\\combined_UC5_DeleteBooking.c" 2
